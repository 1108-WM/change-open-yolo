...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/output/scannet200/subset_sweeps/even96_siou_strict}"
...
run_eval sp_cov030_x3_siou040 \
  "${BEST_ARGS[@]}" \
  --backprojection_superpoint_min_view_siou 0.40

run_eval sp_cov030_x3_siou060 \
  "${BEST_ARGS[@]}" \
  --backprojection_superpoint_min_view_siou 0.60

echo "[DONE] Wrote strict superpoint sIoU sweep outputs to $OUT_DIR"
