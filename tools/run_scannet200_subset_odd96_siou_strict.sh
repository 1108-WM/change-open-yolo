...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/output/scannet200/subset_sweeps/odd96_siou_strict}"
...
run_eval sp_cov030_x3_siou050 \
  "${BEST_ARGS[@]}" \
  --backprojection_superpoint_min_view_siou 0.50

run_eval sp_cov030_x3_siou060 \
  "${BEST_ARGS[@]}" \
  --backprojection_superpoint_min_view_siou 0.60

echo "[DONE] Wrote odd96 strict superpoint sIoU outputs to $OUT_DIR"
