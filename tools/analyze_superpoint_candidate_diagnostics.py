...
def analyze(args):
    ...
    focus_keys = {
        ...
        for scene_name, class_name in [item.split(":", 1)]
    }
    for row in rows:
    ...
    output = {
        ...
        "non_single_core_boundary_candidates": non_single,
    ...
    print(
        "[SUPERPOINT_DIAG] "
        f"single_component point/core_only/core_boundary="
    ...
    print(
        "[SUPERPOINT_DIAG] "
        f"missing_core_only/core_boundary="
