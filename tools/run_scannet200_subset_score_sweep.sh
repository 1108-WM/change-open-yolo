...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/output/scannet200/subset_sweeps/even48_score}"
...
run_eval sam_bpr_scale100 \
  ...
  --backprojection_score_scale 1.00 \
...
echo "[DONE] Wrote subset score sweep outputs to $OUT_DIR"
