...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/output/scannet200/subset_sweeps/even96_sqs}"
...
run_eval sp_cov030_x3_siou060 "20-35 min on RTX 4090" \
  "${BEST_ARGS[@]}"

run_eval sp_cov030_x3_siou060_classcap2 "20-35 min on RTX 4090" \
  "${BEST_ARGS[@]}" \
  --backprojection_max_candidates_per_class 2

run_eval sp_cov030_x3_siou060_sqs_novel_cap085 "20-35 min on RTX 4090" \
  "${BEST_ARGS[@]}" \
...
echo "[DONE] Wrote even96 SQS sweep outputs to $OUT_DIR"
